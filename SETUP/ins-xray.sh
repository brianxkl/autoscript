...
Documentation=https://github.com/brianxkl/autoscript https://github.com/XTLS/Xray-core
...
sleep 1
wget -O add-ws "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/add-ws.sh" && chmod +x add-ws
wget -O cek-ws "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/cek-ws.sh" && chmod +x cek-ws
wget -O del-ws "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/del-ws.sh" && chmod +x del-ws
wget -O renew-ws "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/renew-ws.sh" && chmod +x renew-ws
wget -O user-ws "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/user-ws.sh" && chmod +x user-ws

# // VLESS WS FILES
echo -e "[ ${green}INFO${NC} ] Downloading Vless WS Files"
sleep 1
wget -O add-vless "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/add-vless.sh" && chmod +x add-vless
wget -O cek-vless "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/cek-vless.sh" && chmod +x cek-vless
wget -O del-vless "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/del-vless.sh" && chmod +x del-vless
wget -O renew-vless "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/renew-vless.sh" && chmod +x renew-vless
wget -O user-vless "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/user-vless.sh" && chmod +x user-vless

# // TROJAN WS FILES
echo -e "[ ${green}INFO${NC} ] Downloading Trojan WS Files"
sleep 1
wget -O add-tr "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/add-tr.sh" && chmod +x add-tr
wget -O cek-tr "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/cek-tr.sh" && chmod +x cek-tr
wget -O del-tr "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/del-tr.sh" && chmod +x del-tr
wget -O renew-tr "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/renew-tr.sh" && chmod +x renew-tr
wget -O user-tr "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/user-tr.sh" && chmod +x user-tr

# // OTHER FILES
echo -e "[ ${green}INFO${NC} ] Downloading Others Files"
wget -O certxray "https://raw.githubusercontent.com/brianxkl/autoscript/main/XRAY/cert.sh" && chmod +x certxray
...
sleep 1
wget -O menu-ws "https://raw.githubusercontent.com/brianxkl/autoscript/main/SSH/menu-ws.sh" && chmod +x menu-ws
wget -O menu-vless "https://raw.githubusercontent.com/brianxkl/autoscript/main/SSH/menu-vless.sh" && chmod +x menu-vless
wget -O menu-tr "https://raw.githubusercontent.com/brianxkl/autoscript/main/SSH/menu-tr.sh" && chmod +x menu-tr
wget -O menu-ssh "https://raw.githubusercontent.com/brianxkl/autoscript/main/SSH/menu-ssh.sh" && chmod +x menu-ssh
