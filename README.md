...
<h2 align="center">
<hr>
🚀 Autoscript SSH XRAY Websocket Multiport By Brian (FREE!)🚀
<h2><hr>
...
<b>
 ...
 2. JIKA TERDAPAT SEBARANG BUG / GLITCH BOLEH LAPORKAN PADA SAYA DI TELEGRAM : @brianxkl <br>
 <br>
...
♦️ Installation Link<br>
  ...
  ```html
sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/brianxkl/autoscript/main/V1/setup-lite.sh && chmod +x setup-lite.sh && ./setup-lite.sh
  ```
