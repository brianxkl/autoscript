...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/brianxkl/autoscript/main/SSH/proxy3.js"
cat <<EOF> /etc/systemd/system/sshws.service
[Unit]
Description=Websocket Enabler By Brian
Documentation=https://github.com/brianxkl/autoscript
[Service]
Type=simple
...
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/brianxkl/autoscript/main/SSH/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
